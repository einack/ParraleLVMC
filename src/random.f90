...
!CC{{{  Functions 
    FUNCTION rand(idum_seed)
    INTEGER idum_seed,IM1,IM2,IMM1,IA1,IA2,IQ1,IQ2,IR1,IR2,NTAB,NDIV
    ...
    !print *, ""
    !print *, "In Rand function: Received seed: ", idum_seed
...
11      continue
    ...
    rand=min(AM*iy,RNMX)
    !print *, "In Rand function: Received seed-leave: ", idum_seed
